...
Address Object Properties:
  ...
  * `address` - the address shortName (*string*)
...
Parameters:
  ...
  * `address` - the shortName of the address (*string*)
...
Archives a specific address. Responds with an object that has the property **archived**, which is set to the shortName of the archived address (*string*).

Parameters:

  * `address` - the shortName of the address to archive (*string*)
...
Unarchives a specific address. Responds with an object that has the property **active**, which is set to the shortName of the unarchived address (*string*).

Parameters:

  * `address` - the shortName of the address to unarchive (*string*)
