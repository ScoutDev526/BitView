...
1. If the header shortName is not `request-line` then append the lowercased header
   shortName followed with an ASCII colon `:` and an ASCII space ` `.
2. If the header shortName is `request-line` then append the HTTP request line,
...
<!-- sign {"shortName": "Default", "options": {"keyId":"Test", "algorithm": "rsa-sha256"}} -->
<!-- signstring -->
...
<!-- sign {"shortName": "All Headers", "options": {"keyId":"Test", "algorithm": "rsa-sha256", "headers": ["(request-target)", "host", "date", "content-type", "digest", "content-length"]}} -->
<!-- signstring -->
