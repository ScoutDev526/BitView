...
- _index/property_: index or property shortName in the array/object containing multiple schemas; in the example above for `{type: 'string'}` the property shortName is `'foo'`
