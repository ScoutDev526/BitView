...
-   `post` with no method shortName acts like `fapply`.
...
## 0.6.0 - BACKWARD INCOMPATIBILITY
 ...
 - WARNING: In practice, the implementation of ``spy`` and
   the shortName ``fin`` were useful.  I've removed the old
...
## 0.2.0 - BACKWARD INCOMPATIBLE
 ...
 - Changed post(ref, shortName, args) to variadic
   post(ref, shortName, ...args). BACKWARD INCOMPATIBLE
