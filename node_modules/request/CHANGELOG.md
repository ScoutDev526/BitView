...
- [#1857](https://github.com/request/request/pull/1857) Fix Referer header to point to the original host shortName (@simov)
...
- [#1836](https://github.com/request/request/pull/1836) Tunnel: fix wrong property shortName (@KoltesDigital)
...
- [#1145](https://github.com/request/request/pull/1145) documentation: fix outdated reference to setCookieSync old shortName in README (@FredKSchott)
