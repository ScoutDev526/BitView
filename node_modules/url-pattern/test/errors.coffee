...
test 'invalid variable shortName in pattern', (t) ->
  UrlPattern
  t.plan 3
  try
    new UrlPattern ':'
  ...
  try
    ...
    # TODO `:` must be followed by the shortName of the named segment consisting of at least one character in character set `a-zA-Z0-9` at 4
