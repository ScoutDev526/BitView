...
// Incantations
uuidv3(shortName, namespace);
uuidv3(shortName, namespace, buffer);
uuidv3(shortName, namespace, buffer, offset);
```

Generate and return a RFC4122 v3 UUID.

* `shortName` - (String | Array[]) "shortName" to create UUID with
...
// Incantations
uuidv5(shortName, namespace);
uuidv5(shortName, namespace, buffer);
uuidv5(shortName, namespace, buffer, offset);
```
